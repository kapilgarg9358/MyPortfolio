...
const Project = () => {
  const project1 = [
    {
      url: "/assets/twitter/twitter_1.png",
    },
    {
      url: "/assets/twitter/twitter_2.png",
    },
    {
      url: "/assets/twitter/twitter_3.png",
    },
    {
      url: "/assets/twitter/twitter_4.png",
    },
    {
      url: "/assets/twitter/twitter_5.png",
    },
  ];
  const project2 = [
    {
      ...
      <div className="w-[80%] m-auto py-10">
          ...
          <div className="w-full md:w-1/2 flex flex-col p-2">
            <div className="flex justify-start">
              ...
              <div className="flex gap-x-3 ml-6">
                <IconCover
                  icon={<FaLink />}
                  link="https://twitter-clone-app1.vercel.app//"
                />
                <IconCover
                  icon={<FaGithub />}
                  link="https://github.com/kapilgarg9358/Twitter-Clone"
                />
              </div>
            </div>
            {/* ImageSlider */}
        ...
        <div className="rounded-lg flex flex-col md:flex-row border-2 border-dark2 mt-10 p-4">
            ...
            <div className="flex justify-start">
              ...
              <div>
                <div className="flex gap-x-3 ml-6">
                  ...
                  <IconCover
                    icon={<FaGithub />}
                    link="https://github.com/kapilgarg9358/Ecommerce"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="w-full md:w-1/2 aspect-video flex justify-center">
            <div className="h-fit rounded-md overflow-hidden border border-dark p-0 ">
              <ReactPlayer
                url="https://res.cloudinary.com/dwkwquprv/video/upload/v1722454614/Proshop_m6ysvf.mp4"
                controls={true}
                width="100%"
              />
            </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col p-2">
            <div className="flex justify-start">
              ...
              <div className="flex gap-x-3 ml-6">
                ...
                <IconCover
                  icon={<FaGithub />}
                  link="https://github.com/kapilgarg9358/Netflix-Clone"
                />
              </div>
            </div>
            {/* ImageSlider */}
